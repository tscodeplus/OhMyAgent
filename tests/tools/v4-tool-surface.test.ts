...
const TOOL_CAPABILITIES: Record<string, ToolCapabilityDescriptor> = {
  ...
  file_write:         { category: 'file', readOnly: false, readsFiles: false, writesFiles: true, usesShell: false, usesNetwork: false, usesComputerUse: false, pathAccess: 'write', approvalDefault: 'none' },
  file_edit:          { category: 'file', readOnly: false, readsFiles: true, writesFiles: true, usesShell: false, usesNetwork: false, usesComputerUse: false, pathAccess: 'read_write', approvalDefault: 'none' },
  ...
  todo_write:         { category: 'session', readOnly: false, readsFiles: false, writesFiles: false, usesShell: false, usesNetwork: false, usesComputerUse: false, pathAccess: 'none', approvalDefault: 'none' },
