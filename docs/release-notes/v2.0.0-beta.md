...
Self-Harness is **enabled by default**. Manage triggers, rate limits, and approval rules in Settings → Auto Evolution.
...
Self-Harness **默认启用**。请在设置 → Auto Evolution 中管理触发器、频率限制和审批规则。
