      ...
      <section>
        ...
        <div className="space-y-4 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4">
          <div className="flex items-center justify-between">
            ...
            <Toggle
              checked={!!tools.shellEnabled}
              onChange={(v) => saveField('tools.shellEnabled', v)}
            />
          </div>
          <Select
            label={t('settings.tools.execMode')}
            value={String(tools.shellExecMode || 'balanced')}
            onChange={(e) => saveField('tools.shellExecMode', e.target.value)}
            options={[
              { value: 'balanced', label: t('settings.tools.opt_balanced') },
              { value: 'safe', label: t('settings.policy.mode') + ': safe' },
          ...
          <Select
            ...
            options={['advanced', 'full', 'minimal', 'standard'].map((v) => ({
              value: v,
              label: v,
            }))}
          />
        ...
        <div className="space-y-4 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Select
              ...
              value={String(tools.shellApprovalTimeoutAction || 'deny')}
          ...
          <Select
            ...
            value={String(tools.shellApprovalMode || 'balanced')}
