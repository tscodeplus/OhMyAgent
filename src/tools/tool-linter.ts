...
const VERB_PREFIXES = [
  ...
  'get', 'read', 'write', 'edit', 'list', 'create', 'delete', 'remove', 'update',
  'search', 'find', 'send', 'run', 'execute', 'fetch', 'download', 'upload',
  'add', 'set', 'generate', 'manage', 'toggle', 'stop', 'start', 'enter', 'exit',
  'call', 'describe', 'invoke', 'request', 'capture', 'record', 'store', 'load',
  'save', 'parse', 'extract', 'summarize', 'summarise', 'convert', 'check',
  'validate', 'open', 'close', 'query', 'move', 'copy', 'compare', 'monitor',
  'analyze', 'analyse', 'retrieve', 'enable', 'disable', 'view', 'pause',
  'modify', 'insert', 'replace', 'wait', 'ask', 'return', 'look', 'inspect',
  // ZH
  '获取', '读取', '写入', '编辑', '列出', '创建', '删除', '移除', '更新', '搜索',
  '查找', '发送', '执行', '运行', '下载', '上传', '添加', '设置', '生成', '管理',
  '切换', '停止', '启动', '调用', '请求', '捕获', '记录', '存储', '加载', '保存',
  '解析', '提取', '摘要', '总结', '转换', '检查', '校验', '打开', '关闭', '查询',
  '移动', '复制', '比较', '监听', '计算', '请求', '审批', '拦截', '阻止', '检索',
];
