...
export const DANGEROUS_PATTERNS: DangerousPatternEntry[] = [
  // Remote code execution
  {
    ...
    pattern: 'curl.*\\|.*\\b(bash|sh|zsh|dash|ksh)\\b',
    description: 'curl to shell pipe',
  },
  {
    category: 'remote-exec',
    pattern: 'wget.*\\|.*\\b(bash|sh|zsh|dash|ksh)\\b',
    description: 'wget to shell pipe',
  },
  {
    category: 'remote-exec',
  ...
  { category: 'permission', pattern: 'chmod\\s+666', description: 'world-writable file' },
  {
    category: 'permission',
    pattern: 'chmod\\s+.*o\\+w',
    description: 'add world write permission',
  },
  {
    category: 'permission',
    pattern: 'chown\\s+-R\\s+(root|0)\\b',
    description: 'recursive change to root',
  },
  // Bulk deletion
  ...
  {
    category: 'sensitive-overwrite',
    pattern: '>\\s*[~$]/\\.ssh/',
    description: 'overwrite ssh directory',
  },
  {
    category: 'sensitive-overwrite',
    pattern: '>\\s*[~$]/\\.bashrc',
    description: 'overwrite bashrc',
  },
  {
    category: 'sensitive-overwrite',
    pattern: '>\\s*[~$]/\\.zshrc',
    description: 'overwrite zshrc',
  },
