...
export function mergePartialPersona(base: UserPersona, partial: PartialPersona): UserPersona {
  ...
  if (partial.preferences) {
    if (partial.preferences.tools !== undefined)
      result.preferences.tools = [...partial.preferences.tools];
    if (partial.preferences.languages !== undefined)
      result.preferences.languages = [...partial.preferences.languages];
    if (partial.preferences.workflows !== undefined)
      result.preferences.workflows = [...partial.preferences.workflows];
    if (partial.preferences.communication !== undefined)
      result.preferences.communication = partial.preferences.communication;
  }

  if (partial.skills) {
    if (partial.skills.known !== undefined) result.skills.known = [...partial.skills.known];
    if (partial.skills.learning !== undefined)
      result.skills.learning = [...partial.skills.learning];
  }

  if (partial.workHabits) {
    if (partial.workHabits.hours !== undefined) result.workHabits.hours = partial.workHabits.hours;
    if (partial.workHabits.taskStyle !== undefined)
      result.workHabits.taskStyle = partial.workHabits.taskStyle;
    if (partial.workHabits.qualityPreferences !== undefined)
      result.workHabits.qualityPreferences = [...partial.workHabits.qualityPreferences];
  }

  if (partial.knowledgeDomains) {
    if (partial.knowledgeDomains.expert !== undefined)
      result.knowledgeDomains.expert = [...partial.knowledgeDomains.expert];
    if (partial.knowledgeDomains.proficient !== undefined)
      result.knowledgeDomains.proficient = [...partial.knowledgeDomains.proficient];
    if (partial.knowledgeDomains.interested !== undefined)
      result.knowledgeDomains.interested = [...partial.knowledgeDomains.interested];
  }

  if (partial.projectPreferences) {
    if (partial.projectPreferences.techStacks !== undefined)
      result.projectPreferences.techStacks = [...partial.projectPreferences.techStacks];
    if (partial.projectPreferences.projectTypes !== undefined)
      result.projectPreferences.projectTypes = [...partial.projectPreferences.projectTypes];
    if (partial.projectPreferences.deploymentTargets !== undefined)
      result.projectPreferences.deploymentTargets = [
        ...partial.projectPreferences.deploymentTargets,
      ];
  }

  if (partial.context) {
    if (partial.context.device !== undefined) result.context.device = partial.context.device;
    if (partial.context.environment !== undefined)
      result.context.environment = partial.context.environment;
    if (partial.context.timezone !== undefined) result.context.timezone = partial.context.timezone;
    if (partial.context.activeProjects !== undefined)
      result.context.activeProjects = [...partial.context.activeProjects];
  }

  if (partial.stats) {
    if (partial.stats.totalSessions !== undefined)
      result.stats.totalSessions = partial.stats.totalSessions;
    if (partial.stats.totalMessages !== undefined)
      result.stats.totalMessages = partial.stats.totalMessages;
