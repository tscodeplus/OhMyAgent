...
function addCustomHeadersMiddleware(client: BedrockRuntimeClient, headers: Record<string, string>): void {
	...
	client.middlewareStack.add(middleware as any, { step: "build", name: "pi-ai-custom-headers", priority: "low" });
}
...
function addResponseHeadersMiddleware(
	...
	client.middlewareStack.add(middleware as any, { step: "deserialize", name: "pi-ai-response-headers" });
}
